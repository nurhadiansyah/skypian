...
@section('content')
    <div class="container-fluid py-3">
        <div class="row">
            <div>
                <h2 class="font-weight-bolder mb-0 ">{{ $sensors->id_user }}</h2>
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    <li class="breadcrumb-item text-sm">Last Update</li>
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                            href="javascript:;">{{ $sensors->time }}</a></li>
                                        ...
                                        <ul>
                                            <table border="1">
                                                <tbody>
                                                    @if ($sensors)
                                                        <tr>
                                                            <t><h1> {{ $sensors->water_temp }}&deg;c</h1></td>
                                                        </tr>
                                                    @else
                                                        <tr>
                                                            <td>tidak ada data</td>
                                        ...
                                        <ul>
                                            <table border="1">
                                                <tbody>
                                                    @if ($sensors)
                                                        <tr>
                                                            <t> <h1> {{ $sensors->air_temp }} &deg;c</h1></td>
                                                        </tr>
                                                    @else
                                                        <tr>
                                                            <td>tidak ada data</td>
                            ...
                            value: {
                                ...
                                formatter: function(val) {
                                    return Math.round((val / 100) * maxValue).toFixed(
                                        0)+'  pH '; // Menampilkan nilai sebenarnya
                    ...
                    radialBar: {
                        ...
                        dataLabels: {
                            ...
                            value: {
                                ...
                                formatter: function(val) {
                                    return Math.round((val / 100) * maxValue2).toFixed(
                                        0)+' Hi'; // Menampilkan nilai sebenarnya
                                }
                            }
                        },
                        track: {
